...
const ICON = {
  ...
  backArrow: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1A1A1A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>`,
  ...
  dots: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1A1A1A" stroke-width="2" stroke-linecap="round"><line x1="4" y1="7" x2="20" y2="7"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="17" x2="20" y2="17"/></svg>`,
};
...
function renderBookCanvas(): string {
  ...
  let cardHtml = '';
  if (currentPage === -1) {
    // â”€â”€â”€ PAGE 0: STORY SETTINGS â”€â”€â”€
    cardHtml = `
    ...
    cardHtml = `
      <div class="book-tile book-tile--single" data-book-longpress="${i}">
        ...
        <div class="book-tile__deeper-dive">
          <button class="book-tile__dd-toggle" data-tile-dd-toggle="${i}">
          ...
          <div class="book-tile__dd-panel" data-tile-dd-panel="${i}" style="display:none;">
            <div class="book-tile__dd-integrated">
              ...
              <div class="book-tile__dd-actions">
                ...
                <button class="book-tile__dd-cleanup-btn" data-tile-dd-cleanup="${i}">
  ...
  const cardsHtml = bookPages.map((page, i) => `
    <div class="sb-card" data-sb-card="${i}">
      ...
      <details class="sb-card__deeper-dive">
        <summary class="sb-card__dd-summary">ðŸŽ“ DEEPER DIVE</summary>
...
const attachListeners = () => {
    ...
    if (phase === 'canvas' && selectedFormat === 'scroll') {
      ...
      // Character Popup â€” render as portal on document.body
      if (activeCharPopup !== null) {
          ...
          <div class="char-popup-overlay" id="char-popup-overlay">
            <div class="char-popup">
              <div class="char-popup__header">
                ...
                <button id="char-popup-close" style="background:none; border:none; font-size:1.2rem; cursor:pointer; color:var(--color-text-muted);">âœ•</button>
              </div>
              <div class="char-popup__image-area" id="char-popup-image-area">
                ${char.image 
                  ? `<img src="${char.image}" alt="Character ${char.name}" />`
                  : `<div style="display:flex;flex-direction:column;align-items:center;gap:6px;color:var(--color-text-muted);"><span style="font-size:1.5rem;">ðŸ“·</span><span style="font-size:0.78rem;">Tap to upload</span></div>`
                }
              ...
              <div class="char-popup__actions">
                <button class="char-popup__btn char-popup__btn--generate" id="char-popup-generate" ${isGenerating ? 'disabled' : ''}>
                  ${isGenerating ? 'â³ Generating...' : 'âš¡ Generate'}
                </button>
        ...
        // Image area click â€” trigger file input
